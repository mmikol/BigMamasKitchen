import {Type, Variable} from "./ast.js"
//import * as stdlib from "./stdlib.js"

export default function analyze(node) {
    Boolean.prototype.type = Type.BOOLEAN
    Number.prototype.type = Type.NUMBER
    //BigInt.prototype.type = ast.Type.INT
...
//     const initialContext = new Context()
  ...
  const check = self => ({
    ...
    isBoolean() {
      must(self.type === TypeIdentifier.BOOLEAN, `Expected a boolean, found ${self.type.name}`)
    },
    isInteger() {
  ...
  class Context {
    ...
    VariableDeclaration(d) {
      ...
      //check(d.initializer.type).isAssignableTo(d.type)
